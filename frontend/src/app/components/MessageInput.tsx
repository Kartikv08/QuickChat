  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          type="submit"
          className="bg-blue-600 hover:bg-blue-700 rounded-lg px-4 py-2 transition-colors flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed text-white"
