      ...
      <div className="max-w-md w-full">
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
          <div className="text-center mb-8 relative">
            ...
            >
              <ChevronLeft className="w-6 h-6s" />
            </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              >
                Enter your 6-digit OTP code below to verify your email.
              </label>
            ...
            <button
              type="submit"
              className="mt-2 w-full bg-blue-600 text-white py-4 px-6 rounded-lg font-semibold hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={loading}
            >
              {loading ? (
